...
<div class="container mt-3">
    <div class="row">
        <div class="input-group mb-3">
            <input type="text" class="form-control" v-model="libroBuscado" placeholder="¿Qué libro estás buscando?"
                @input="buscarLibros">
    ...
    <div class="row">
        <div class="col-md-12" v-for="genero in generos" :key="genero.id">
            ...
            <div :id="'librosCarousel-' + genero.id" class="carousel slide">
                <div class="carousel-inner">
                    <div class="carousel-item" v-for="(libroChunk, index) in chunkedLibrosFiltradosPorGenero(genero.id)"
                        :class="{ active: index === 0 }">
                        <div class="row">
                            <div class="col-md-3" v-for="libro in libroChunk">
                                ...
                                <div class="card">
                                    ...
                                    <div>
                                        <button class="btn btn-primary" @click="irDetalles(libro.id)">Ver
                                            Detalles</button>
                                    </div>
                                </div>
                            </div>
                ...
                <button class="carousel-control-prev" type="button" :data-bs-target="'#librosCarousel-' + genero.id"
                    data-bs-slide="prev">
                    <span class="carousel-control-prev-icon" aria-hidden="true"></span>
                    <span class="visually-hidden">Anterior</span>
                </button>
                <button class="carousel-control-next" type="button" :data-bs-target="'#librosCarousel-' + genero.id"
                    data-bs-slide="next">
